            ...
            <div class="form-parent">
                <form v-on:submit.prevent="update(this)" class="form" method="POST">
                    ...
                    <div class="sub-form">
                      ...
                      <div class="form-group">
                          <button class="raise btn-green" type="button" v-on:click="trueEdit()" :hidden="this.statusEdit">Editar campos</button>
                          <router-link :to="{name: 'gerente-habitaciones'}" class="button raise btn-red" type="button" :hidden="this.statusEdit">Volver</router-link>
                          <button class="raise btn-green" type="submit" :hidden="!this.statusEdit">Guardar cambios</button>
                          <button class="raise btn-red" type="button" v-on:click="falseEdit()" :hidden="!this.statusEdit">Cancelar</button>
                      </div>
                    </div>
                </form>
            </div>
